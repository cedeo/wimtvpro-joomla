...
$settings_base_url = "index.php?option=com_wimtvpro&view=settings";
if ($view_page) {
    // ACCOUNT WIMTV
    $settings_items["credential"]["url"] = $settings_base_url . "&credential=1";
    $settings_items["credential"]["class"] = "other";
    $settings_items["credential"]["text"] = JText::_("COM_WIMTVPRO_CONFIG_CREDENTIALTAB");
    // SKIN
    $settings_items["skin"]["url"] = $settings_base_url . "&skin=1";
    $settings_items["skin"]["class"] = "config";
    $settings_items["skin"]["text"] = JText::_("COM_WIMTVPRO_CONFIG_SKIN");
    // PRICE
    $settings_items["price"]["url"] = $settings_base_url . "&pack=1";
    $settings_items["price"]["class"] = "pricing";
    $settings_items["price"]["text"] = JText::_("COM_WIMTVPRO_CONFIG_PRICING");
    // PAYMENT
    $settings_items["payment"]["url"] = $settings_base_url . "&update=1";
    $settings_items["payment"]["class"] = "payment";
    $settings_items["payment"]["text"] = JText::_("COM_WIMTVPRO_CONFIG_PAYMENT");
    // LIVE
    $settings_items["live"]["url"] = $settings_base_url . "&update=2";
    $settings_items["live"]["class"] = "live";
    $settings_items["live"]["text"] = JText::_("COM_WIMTVPRO_CONFIG_WIMLIVE");
    // USER PERSONAL INFO
    $settings_items["personal"]["url"] = $settings_base_url . "&update=3";
    $settings_items["personal"]["class"] = "user";
    $settings_items["personal"]["text"] = JText::_("COM_WIMTVPRO_CONFIG_USER");
    // FEATURES
    $settings_items["features"]["url"] = $settings_base_url . "&update=4";
    $settings_items["features"]["class"] = "other";
    $settings_items["features"]["text"] = JText::_("COM_WIMTVPRO_CONFIG_FEATURES");

    $activeTab = "credential";
    if (isset($_GET["credential"]) && $_GET["credential"] == "1") {
        $activeTab = "credential";
//    } elseif (!isset($_GET["credential"]) AND !isset($_GET["update"]) AND !isset($_GET["pack"])) {
    } elseif (isset($_GET["skin"]) && $_GET["skin"] == "1") {
        $activeTab = "skin";
    } elseif (isset($_GET["pack"]) && $_GET["pack"] == "1") {
        $activeTab = "price";
    } elseif (isset($_GET["update"]) && $_GET["update"] == "1") {
        $activeTab = "payment";
    } elseif (isset($_GET["update"]) && $_GET["update"] == "2") {
        $activeTab = "live";
    } elseif (isset($_GET["update"]) && $_GET["update"] == "3") {
        $activeTab = "personal";
    } elseif (isset($_GET["update"]) && $_GET["update"] == "4") {
        $activeTab = "features";
    }
    $settings_items[$activeTab]["class"].= " active";

    foreach ($settings_items as $settings_item) {
        $submenu_item = "<li><a href='" . $settings_item['url'] . "' class='" . $settings_item['class'] . "'>" . $settings_item['text'] . "</a>";
            ...
            echo '
                <form action="index.php?option=com_wimtvpro&view=settings&update=1" method="post" name="adminForm" enctype="multipart/form-data">
                    <fieldset class="adminform">
                        ...
                        <ul class="adminformlist">
                            <li>
                                <label for="affiliate">' . JText::_("COM_WIMTVPRO_CONFIG_PRICING_AFFILIATE") . '</label>
                                    <input type="checkbox" id="edit-affiliate" name="affiliate" ' . $affiliate . ' />
                            </li>
                            <li id="field-companyName">
                                <label for="companyName">' . JText::_("COM_WIMTVPRO_CONFIG_PRICING_COMPANY_NAME") . '</label>
                                <input type="text" id="edit-companyName" name="companyName" value="' . $dati['companyName'] . '" size="100" maxlength="100" />
                            </li>
                            <li id="field-affiliateConfirm">
                                <label for="affiliateConfirm">' . JText::_("COM_WIMTVPRO_CONFIG_PRICING_AFFILIATE_CONFIRM") . '</label>
                    ...
                    <fieldset class="adminform">
                        ...
                        <ul class="adminformlist">
                            <li>
                                <label for="paypalEmail">' . JText::_("COM_WIMTVPRO_CONFIG_PRICING_PAYPAL") . '</label>
                    ...
                    <fieldset class="adminform">
                        ...
                        <ul class="adminformlist">
                            <li>
                                <label for="taxCode">' . JText::_("COM_WIMTVPRO_CONFIG_PRICING_TAX_TAXCODE") . '</label>
                                <input type="text" id="edit-taxCode" name="taxCode" value="' . $dati['taxCode'] . '" size="80" maxlength="20"/>
                            </li>
                            <li>
                                <label for="vatCode">' . JText::_("COM_WIMTVPRO_CONFIG_PRICING_TAX_VATCODE") . '</label>
                    ...
                    <fieldset class="adminform">
                        ...
                        <ul class="adminformlist">
                            <li>
                                <label for="billingAddress[street]">' . JText::_("COM_WIMTVPRO_CONFIG_PRICING_ADDRESS_STREET") . '</label>
                            ...
                            <li>
                                <label for="billingAddress[city]">' . JText::_("COM_WIMTVPRO_CONFIG_PRICING_ADDRESS_CITY") . '</label>
                            ...
                            <li>
                                <label for="billingAddress[state]">' . JText::_("COM_WIMTVPRO_CONFIG_PRICING_ADDRESS_STATE") . '</label>
                            ...
                            <li>
                                <label for="billingAddress[zipCode]">' . JText::_("COM_WIMTVPRO_CONFIG_PRICING_ADDRESS_ZIPCODE") . '</label>
...
// NS: WE HIDE BOTH eventResellerEnabled AND eventOrganizerEnabled
// 
//                echo '<script>
//                        jQuery(document).ready(function() {
...
//                         });
//                       </script>';
            echo '<form action="index.php?option=com_wimtvpro&view=settings&update=2" method="post" name="adminForm" enctype="multipart/form-data">
                            <fieldset class="adminform">
...
// NS: WE HIDE BOTH eventResellerEnabled AND eventOrganizerEnabled
// 
//                echo '<li><label for="eventResellerEnabled">' . JText::_("COM_WIMTVPRO_CONFIG_WIMLIVE_RESALE") . '</label></li>
//                            <input type="checkbox" id="edit-eventResellerEnabled" name="eventResellerEnabled" value="true"';
//                if (strtoupper($dati['eventResellerEnabled']) == "TRUE") {
//                    echo ' checked="checked"';
//                }
//                
//                echo '/><div class="empty"></div>' . JText::_("COM_WIMTVPRO_CONFIG_WIMLIVE_RESALE_DESC") . '</li>
...
//                
//                if (strtoupper($dati['eventOrganizerEnabled']) == "TRUE")
//                    echo ' checked="checked"';
//                echo '/>
//                    <div class="empty"></div>' . JText::_("COM_WIMTVPRO_CONFIG_WIMLIVE_ORGANIZ_DESC") . '</li></ul>';
        ...
        case "personal":
            $dati = getDatiProfilo();
            echo '
                <form action="index.php?option=com_wimtvpro&view=settings&update=3" method="post" name="adminForm" enctype="multipart/form-data">
                    <fieldset class="adminform">
                        <legend>' . JText::_("COM_WIMTVPRO_CONFIG_USER") . '</legend
                            <ul class="adminformlist">
                                <li>
                                ...
                                <li>
                                    <label for="edit-Surname">' . JText::_("COM_WIMTVPRO_CONFIG_USER_LAST") . '<span class="form-required" title="">*</span></label>
                                    <input type="text" id="edit-Surname" name="surname" value="' . $dati['surname'] . '" size="40" maxlength="200"/>
                                </li>
                                <li>
                                    <label for="edit-Email">' . JText::_("COM_WIMTVPRO_CONFIG_USER_EMAIL") . '<span class="form-required" title="">*</span></label>
                                    <input type="text" id="edit-email" name="email" value="' . $dati['email'] . '" size="80" maxlength="200"/>
                                </li>
                                <li>
                                    <label for="sex">' . JText::_("COM_WIMTVPRO_CONFIG_USER_GENDER") . '<span class="form-required" title="">*</span></label>';
            $arr = array(
            ...
            echo '
                                ...
                                <li>
                                    <label for="dateOfBirth">' . JText::_("COM_WIMTVPRO_CONFIG_USER_BIRTH") . '</label>';
            //convert date		
            ...
            echo '
                                ...
                                <li>
                                    <label for="twitterUri">' . JText::_("COM_WIMTVPRO_CONFIG_USER_TW") . '</label>
                                        </th>
                                        <input  type="text"  id="edit-twitterURI" name="twitterUri" value="' . $dati['twitterURI'] . '" size="100" maxlength="100">
                                </li>
                                <li>
                                    <label for="linkedInUri">' . JText::_("COM_WIMTVPRO_CONFIG_USER_LI") . '</label>
        ...
        case "features":
            ...
            echo '
                <form action="index.php?option=com_wimtvpro&view=settings&update=4" method="post" name="adminForm" enctype="multipart/form-data">
                    <fieldset>
                        <ul class="adminformlist">
                            <li>
                                <label for="edit-name">' . JText::_('COM_WIMTVPRO_CONFIG_FEATURES_INDEX') . ' (<a href="http://www.wim.tv/">www.wim.tv</a>)</label>';
            $arr = array(
            ...
            if ($dati['hidePublicShowtimeVideos'] == "true") {
            ...
            echo '>
                <legend>' . JText::_('COM_WIMTVPRO_CONFIG_FEATURES_PAGE_TITLE') . '</legend>
                        <ul class="adminformlist">
                            <li>
                                <label for="pageName">' . JText::_('COM_WIMTVPRO_CONFIG_FEATURES_PAGE') . '</label>
                                    <input  type="text"  id="edit-pageName" name="pageName" value="' . $dati['pageName'] . '" size="100" maxlength="100">
                            </li>
                            <li>
                                <label for="pageDescription">' . JText::_('COM_WIMTVPRO_CONFIG_FEATURES_DESC') . '</label>
    ...
    /*
      ...
      //
      // Recupera cookie sessione
      // scurl_setopt($ch, CURLOPT_COOKIEFILE, $directoryCookie . "/" . $fileCookie );
...
function getDatiProfilo() {
    $response = apiGetProfile();
    $dati = json_decode($response, true);
    $dati['companyName'] = isset($dati['companyName']) ? $dati['companyName'] : "";
    $dati['paypalEmail'] = isset($dati['paypalEmail']) ? $dati['paypalEmail'] : "";
    $dati['taxCode'] = isset($dati['taxCode']) ? $dati['taxCode'] : "";
    $dati['vatCode'] = isset($dati['vatCode']) ? $dati['vatCode'] : "";
    $dati['street'] = isset($dati['street']) ? $dati['street'] : "";
    $dati['state'] = isset($dati['state']) ? $dati['state'] : "";
    $dati['zipCode'] = isset($dati['zipCode']) ? $dati['zipCode'] : "";
    $dati['billingAddress'] ['street'] = isset($dati['billingAddress'] ['street']) ? $dati['billingAddress'] ['street'] : "";
    $dati['billingAddress'] ['city'] = isset($dati['billingAddress'] ['city']) ? $dati['billingAddress'] ['city'] : "";
    $dati['billingAddress'] ['state'] = isset($dati['billingAddress'] ['state']) ? $dati['billingAddress'] ['state'] : "";
    $dati['billingAddress'] ['zipCode'] = isset($dati['billingAddress'] ['zipCode']) ? $dati['billingAddress'] ['zipCode'] : "";
    $dati['facebookURI'] = isset($dati['facebookURI']) ? $dati['facebookURI'] : "";
    $dati['twitterURI'] = isset($dati['twitterURI']) ? $dati['twitterURI'] : "";
    $dati['linkedInURI'] = isset($dati['linkedInURI']) ? $dati['linkedInURI'] : "";
    return $dati;
}
?>

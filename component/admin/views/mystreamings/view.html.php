        ...
        if (isset($_GET["inserInto"])) {
            ...
            $document->addScriptDeclaration('
                jQuery(document).ready(function() {
                    jQuery(".iframeClickedShortCode").click(function(){
                        width  ="";
                        height ="";
                        showtimeID = jQuery(this).attr("id");
                        urn = jQuery(this).attr("rel");
                        jQuery("input").each(function(){
                            if (jQuery(this).attr("id")=="width_" + urn){
                                width = jQuery(this).val();
                            }
                            if (jQuery(this).attr("id")=="height_" + urn){
                                height = jQuery(this).val();
                            }
                         });
                        videosize= width + "|" + height;
                        shortcode = "[wimtv]" + showtimeID + "|" + videosize + "[/wimtv]";
                        window.parent.jInsertEditorText(shortcode,"' . $_GET["e_name"] . '");

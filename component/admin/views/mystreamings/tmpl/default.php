...
if ($view_page) {
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_wimtvpro&view=mystreamings'); ?>"
        ...
        <table class="wimvodTable">
            <tr>
                <td id="wimvodTable_colVideo">
                ...
                <td id="wimvodTable_colPlaylist">
                    <div class="playlistElenco">
                        ...
                        <?php if (!isset($_GET["inserInto"])) { ?>
                            ...
                            <?php //My Playlist  ?>
                            <p>
                                <a href="index.php?option=com_wimtvpro&view=myplaylist&layout=edit">
                                    <?php echo JText::_('COM_WIMTVPRO_PLAYLIST_CREATE'); ?>
                                </a>
                            </p>
                        ...
                        foreach ($arrayPlayList as $field) {
                            ...
                            if (!isset($_GET["inserInto"])) {
                                ...
                                echo '
                        <div class="playlist" id="playlist_' . $count . '" rel="' . $field->id . '">'
                                . $field->name . '(<span class="counter">' . $countVideo . '</span>)';
                                ...
                                $addIcon = "<img style='vertical-align: middle;' src='" . JURI::base() . "components/com_wimtvpro/assets/images/add.png'/>";
                                echo '<br/>
                        <a class="insertPlayListIntoContent" href="#" onclick="var iframe = unescape(\'' . $iframeInsert . '\'); iframe = iframe.replace(/\+/g, \' \');   window.parent.jInsertEditorText(iframe,\'' . $_GET["e_name"] . '\');window.parent.SqueezeBox.close();">' . $addIcon . JText::_('COM_MEDIA_INSERT') . '</a>';
                            }

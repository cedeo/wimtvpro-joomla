...
if (count($arrayVideo) == 1 && !$arrayVideo[0])
    $arrayVideo = array();
...
<form enctype="multipart/form-data"
      action="<?php echo JRoute::_('index.php?option=com_wimtvpro&view=mystreamings'); ?>" 
    ...
    <fieldset class="adminform">
        ...
        <?php
         $playList_iframe= "<iframe src='index.php?option=com_wimtvpro&view=embeddedplaylist&tmpl=component&id=" . $id . "' width='100%' height='" . ($height + 70) . "px' frameborder='0' style='overflow:none;'></iframe>";
//        echo "<legend>Embedded:</legend><textarea style='resize: none; width:90%;height:70px;font-size:10px' readonly='readonly' onclick='this.focus(); this.select();'>" . htmlentities($output) . "</textarea>";
        echo "<legend>Embedded:</legend><textarea style='resize: none; width:90%;height:30px;font-size:10px' readonly='readonly' onclick='this.focus(); this.select();'>" . $playList_iframe . "</textarea>";
        ?>

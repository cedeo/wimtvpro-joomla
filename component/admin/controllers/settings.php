...
class wimtvproControllersettings extends JControllerAdmin {
    ...
    function wimtvlogout() {
        ...
        $cache = JCache::getInstance('callback', $options);
        $cache->clean();
        JFactory::getApplication()->enqueueMessage(JText::_("COM_WIMTVPRO_MSG_WIMTVLOGOUT"));
        $this->setRedirect('index.php?option=com_wimtvpro&view=settings');
    }
